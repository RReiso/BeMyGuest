class ContactsController < ApplicationController
  ...
  before_action :get_contact, only: %i[update destroy]
	...
	def create
		...
		flash[:danger] = 'Error creating contact. Please try again.' unless contact.save
...
# 		redirect_to user_user_contacts_path(@user, @user)
# 	end

# 	def update_contact_state
# 		@contact.update(contact_checked_params)
#     head :no_content
# 	end
...
# 	def contact_checked_params
# 		params.require(:contact).permit(:checked)
